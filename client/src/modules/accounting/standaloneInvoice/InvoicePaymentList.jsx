    ...
    const columns = [
        {
            headerName: '#', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/accountings/invoicePayment/${params.value}?mode=edit`}><BsBoxArrowInUpRight /></Button>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/accountings/invoicePayment/${params.value}?mode=view`}><BsEyeFill /></Button>
                </>
        },
        ...
        // {
        //     headerName: 'Invoice Status', field: 'invoiceStatus', cellRendererFramework: (params) => (renderStatus(params.value)),
        // },
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Invoice Payments</h3></Col>
                    </Row>
                    <Row>
                        <Col></Col>
                        <Col md="4" sm="6">
