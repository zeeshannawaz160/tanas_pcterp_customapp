...
export default function OutstandingBillsReport() {
    ...
    useEffect(async () => {
        const response = await ApiService.get('bill/stats?paymentStatus=Not Paid');
    ...
    const columns = [
        { field: 'referenceNumber', headerName: 'Reference Number', flex: 1, minWidth: 150 },
        { field: 'sourceDocument', headerName: 'Source Document', valueGetter: getSourceDocumentValue, flex: 1, minWidth: 150 },
        { field: 'vendor', headerName: 'Vendor', valueGetter: getVendorValue, flex: 1, minWidth: 150 },
        { field: 'billDate', headerName: 'Bill Date', valueGetter: (params) => params.data?.billDate ? moment(params.data?.billDate).format("DD/MM/YYYY HH:mm:ss") : "Not Available", flex: 1, minWidth: 150 },
    ...
    const handlePrintReport = async () => {
        ...
        doc.text("Outstanding Bill Report", 190, 50);
        ...
        doc.autoTable({
            ...
            columns: [
                ...
                { header: 'Recipient Account', dataKey: 'recepientAccount' },
                { header: 'Total', dataKey: 'total' },
            ],
            // didDrawPage: (d) => height = d.cursor.y,// calculate height of the autotable dynamically
        })

        doc.save(`Bills Report - ${state.name}.pdf`);
    }
...
//     const columns = [
//         { field: 'billReference', headerName: 'Reference Number', flex: 1, minWidth: 150 },
//         { field: 'sourceDocument', headerName: 'Source Document', valueGetter: getSourceDocumentValue, flex: 1, minWidth: 150 },
//         { field: 'vendor', headerName: 'Vendor', valueGetter: getVendorValue, flex: 1, minWidth: 150 },
//         { field: 'billDate', headerName: 'Bill Date', valueGetter: getDateValue, flex: 1, minWidth: 150 },
...
//             newObject.billReference = item.billReference;
//             newObject.sourceDocument = item.sourceDocument;
//             newObject.vendor = item.vendor;
//             newObject.billDate = item.billDate;
...
//             body: itemObjects,
//             columns: [
//                 { header: 'Reference Number', dataKey: 'billReference' },
//                 { header: 'Source Document', dataKey: 'sourceDocument' },
//                 { header: 'Vendor', dataKey: 'vendor' },
//                 { header: 'Bill Date', dataKey: 'billDate' },
//                 { header: 'Recipient Account', dataKey: 'recipientAccount' },
//                 { header: 'Total', dataKey: 'total' },
//             ],
//             // didDrawPage: (d) => height = d.cursor.y,// calculate height of the autotable dynamically
//         })
