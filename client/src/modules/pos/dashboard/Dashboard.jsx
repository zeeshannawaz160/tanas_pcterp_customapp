            ...
            <Container className="pct-app-content-body p-0 m-0" fluid>
                <div className="PCTAppContent">
                    <div className="PCTAppLeftContent">
                        <div style={{ height: '100%', flex: 7, overflowY: 'scroll', overflowX: 'hidden', paddingTop: '5rem', paddingBottom: '1rem', position: 'relative' }}>
                            <div style={{ width: '63.63%', minWidth: '50rem', height: '5rem', backgroundColor: '#eee', position: 'fixed', zIndex: 1, marginTop: '-5rem', boxShadow: '0 0.125rem 0.25rem rgba(0, 0, 0, 0.2)', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: '0 1.25rem' }}>
