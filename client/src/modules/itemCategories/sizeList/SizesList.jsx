    ...
    const columns = [
        {
            headerName: ' ', field: '_id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/${url?.split('/')[1]}/sizeList/${params.value}`}><BsBoxArrowInUpRight /></Button>
                    {/* <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/${url?.split('/')[1]}/product/${params.value}`}><BsEyeFill /></Button> */}
                </>
        },
        { headerName: 'Size Name', field: 'name' },
    ]
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Size List</h3></Col>
                    </Row>
                    <Row>
                        <Col><Button as={Link} to={`/${url?.split('/')[1]}/sizeList`} variant="primary" size="sm">Create</Button></Col>
                    </Row>
                </Container>
