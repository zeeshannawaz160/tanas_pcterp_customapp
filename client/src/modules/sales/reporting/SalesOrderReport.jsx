...
export default function SalesOrderReport() {
    ...
    const handlePrintReport = async () => {
        ...
        doc.text("Sales Order Report", 190, 50);
        ...
        doc.save(`Sales Order Report - ${state.name}.pdf`);
    }
    ...
    const columns = [
        ...
        { headerName: 'Delivered Date', field: 'deliveryDate', valueGetter: (params) => params.data?.deliveryDate ? moment(params.data?.deliveryDate).format("MM/DD/YYYY") : "Not Available" },
