...
export default function DeliveriesReport() {
    ...
    const handlePrintReport = async () => {
        ...
        doc.text("Delivery Product Report", 190, 50);
        ...
        doc.save(`Delivery Product Report - ${state.name}.pdf`);
    }
    ...
    const columns = [
        ...
        { headerName: 'Sales Order', field: 'sourceDocument' },
    ...
    return (
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Product Delivery Report</h3></Col>
                    </Row>
                    <Row>
                        <Col>
