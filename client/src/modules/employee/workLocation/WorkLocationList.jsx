    ...
    const columns = [
        {
            headerName: ' ', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/employees/worklocation/${params.value}?mode=edit`}><BsBoxArrowInUpRight /></Button>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/employees/worklocation/${params.value}?mode=view`}><BsEyeFill /></Button>
                </>
        },
        { headerName: 'Location', field: 'name' },
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>Work Locations</h3></Col>
                    </Row>
                    <Row>
                        <Col><Button as={Link} to="/employees/worklocation" variant="primary" size="sm">Create</Button></Col>
                    </Row>
                </Container>
