...
import WorkCenterApp from '../../microapps/workCenterApp/Index';
import BOMApp from '../../microapps/bomApp/Index';
import JobOrderApp from '../../microapps/jobOrderApp/Index';
        ...
        <AppContainer>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="me-auto">
                                ...
                                }
                                {
                                    _header &&
                                    _header.header &&
                                    _header.header.navbar_left?.nav_dropdowns && _header.header?.navbar_left?.nav_dropdowns?.map(dropdown => {
                                        console.log(dropdown)
                                        return <NavDropdown active title={`${dropdown?.nav_dropdown?.nav_dropdown_name}`} id="collasible-nav-dropdown">
                                            {
                                                dropdown?.nav_dropdown?.nav_dropdown_items?.map((dropdownItem, index) => {
            ...
            <AppContentContainer>
                <Routes>
                    ...
                    <Route path="/inventoryadjustment/*" element={<InventoryAdjustmentApp />} />
                    <Route path="/product/*" element={<ProductApp />} />
                    <Route path="/workcenters/*" element={<WorkCenterApp />} />
                    <Route path="/boms/*" element={<BOMApp />} />
                    <Route path="/joborders/*" element={<JobOrderApp />} />
                </Routes>
