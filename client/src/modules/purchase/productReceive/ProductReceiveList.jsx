...
export default function ProductReceiveList() {
    ...
    const columns = [
        ...
        { headerName: 'Receipt#', field: 'name' },
        { headerName: 'Sourced Document', field: 'sourceDocument.name' },
        { headerName: 'Vendor Name', field: 'vendor.name' },
        { headerName: 'Effective Date', field: 'effectiveDate', valueGetter: (params) => params.data?.effectiveDate ? moment(params.data?.effectiveDate).format("MM/DD/YYYY") : "Not Available" },
