...
export default function Company() {
    ...
    useEffect(async () => {
        ...
        if (!isAddMode) {
            ApiService.setHeader();
            ApiService.get(`company/${id}`).then(response => {
            ...
            <Form onSubmit={handleSubmit(onSubmit)} className="pct-app-content" >
                <Container className="pct-app-content-header  m-0 pb-2" style={{ borderBottom: '1px solid black' }} fluid>
                    <Row>
                        <Breadcrumb style={{ fontSize: '24px' }}>
                            <Breadcrumb.Item className="breadcrumb-item" linkAs={Link} linkProps={{ to: '/settings' }} ><h3 className="breadcrum-label">Companies</h3></Breadcrumb.Item>
                    ...
                    <Row>
                        <Col>
                            ...
                            <Button as={Link} to="/settings/companies" variant="light" size="sm">DISCARD</Button>
                ...
                <Container className="pct-app-content-body p-0 m-0 mt-2" fluid>
                    <Container className="mt-2" fluid>
                        ...
                        <Row>
                            <Form.Group as={Col} md="4" className="mb-2">
                                <Form.Label className="m-0">Fax</Form.Label>
                                <Form.Control
                                    type="text"
                                    id="fax"
                                    name="fax"
