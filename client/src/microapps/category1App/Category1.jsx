...
export default function Category1() {
                    ...
                    if (filteredParent.length > 0) {
                        await ApiService.patch(`itemCategory/${responseData.document[0].id}`, { parent: filteredParent })
                            .then(secondResponse => {
                                ...
                                ApiService.get('/itemCategory/search?type=firstCategory').then(res => {
    ...
    useEffect(async () => {
        ...
        const response = await ApiService.get('/itemCategory/search?type=firstCategory');
                ...
                <Row>
                    <Col className='p-0 ps-2'>
                        <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                            <Breadcrumb.Item active> <div className='breadcrum-label-active'>CATEGORY 1</div></Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
