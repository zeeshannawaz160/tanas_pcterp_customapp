...
export default function InventoryAdjustmentList() {
    ...
    const columns = [
        {
            headerName: ' ', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <>
                    <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/${rootPath}/inventoryadjustment/edit/${params.value}`}><BsBoxArrowInUpRight /></Button>
    ...
    return (
        <AppContentForm>
                ...
                <Container fluid >
                    ...
                    <Row style={{ marginTop: '-10px' }}>
                        <Col className='p-0 ps-1'>
                            <Button size="sm" as={Link} to={`/${rootPath}/inventoryadjustment/add`}>CREATE</Button>{" "}
                        </Col>
                        <Col md="4" sm="6">
                            <Row>
            ...
            <AppContentBody>
                <div className="ag-theme-alpine" style={{ padding: "0 8px", height: '100%', width: '100%' }}>
                    <AgGridReact
