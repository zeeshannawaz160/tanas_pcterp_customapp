...
import { errorMessage, formatAddressNew } from '../../helpers/Utils'
    ...
    const createDocument = (data) => {
        ...
        return ApiService.post('/customer', data).then(response => {
            if (response.data.isSuccess) {
                navigate(`/${rootPath}/customers/list`)
            }
        }).catch(e => {
                ...
                <Container fluid >
                    ...
                    <Row style={{ marginTop: '-10px' }}>
                        <Col className='p-0 ps-1'>
                            ...
                            <Button as={Link} to={`/${rootPath}/customers/list`} variant="secondary" size="sm">DISCARD</Button>
