...
export default function Size() {
                    ...
                    if (filteredParent.length > 0) {
                        await ApiService.patch(`itemCategory/${responseData.document[0].id}`, { parent: filteredParent })
                            .then(secondResponse => {
                                ...
                                ApiService.get('/itemCategory/search?type=size').then(res => {
    ...
    useEffect(async () => {
        ...
        const response = await ApiService.get('/itemCategory/search?type=size');
    ...
    return (
        ...
        //             <div className="ag-theme-alpine" style={{ padding: "5px 10px 10px", height: '100%', width: '100%', zIndex: 10 }}>
        //                 <AgGridReact
                    ...
                    <Row>
                        <Col className='p-0 ps-2'>
                            <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                                <Breadcrumb.Item active> <div className='breadcrum-label-active'>SIZE</div></Breadcrumb.Item>
                            </Breadcrumb>
                        </Col>
                    </Row>
