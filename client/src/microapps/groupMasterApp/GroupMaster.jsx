...
export default function GroupMaster() {
                    ...
                    if (filteredParent.length > 0) {
                        await ApiService.patch(`itemCategory/${responseData.document[0].id}`, { parent: filteredParent })
                            .then(secondResponse => {
                                ...
                                ApiService.get('/itemCategory/search?type=groupMaster').then(res => {
    ...
    useEffect(async () => {
        ...
        const response = await ApiService.get('/itemCategory/search?type=groupMaster');
                ...
                <Row>
                    <Col className='p-0 ps-2'>
                        <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                            <Breadcrumb.Item active> <div className='breadcrum-label-active'>GROUP MASTERS</div></Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
