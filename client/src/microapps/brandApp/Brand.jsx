...
export default function Brand() {
                    ...
                    if (filteredParent.length > 0) {
                        await ApiService.patch(`itemCategory/${responseData.document[0].id}`, { parent: filteredParent })
                            .then(secondResponse => {
                                ...
                                ApiService.get('/itemCategory/search?type=brand').then(res => {
    ...
    useEffect(async () => {
        ...
        const response = await ApiService.get('/itemCategory/search?type=brand');
                ...
                <Row>
                    <Col className='p-0 ps-2'>
                        <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                            <Breadcrumb.Item active> <div className='breadcrum-label-active'>BRAND LIST</div></Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <Row>
                        ...
                        {brandList && selectOptions && <Form.Group md="4" className="mb-0" as={Col}>
                            <Form.Label className="mb-0">GROUP MASTER</Form.Label>
