                ...
                <Container className="pct-app-content-header  m-0 pb-2" style={{ borderBottom: '1px solid black' }} fluid>
                    <Row>
                        ...
                        <Breadcrumb style={{ fontSize: '24px' }}>
                            <Breadcrumb.Item className="breadcrumb-item" linkAs={Link} linkProps={{ to: `/${rootPath}/customers?stack=${stack}` }} style={{ textDecoration: 'none !important' }} ><h3 className="breadcrum-label" style={{ textDecoration: 'none !important' }}>Customers</h3></Breadcrumb.Item>
                    ...
                    <Row>
                        <Col>
                            ...
                            <Button as={Link} to={`/${rootPath}/customers?stack=${stack}`} variant="light" size="sm">DISCARD</Button>{" "}
