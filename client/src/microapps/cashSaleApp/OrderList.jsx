    ...
    const columns = [
        {
            headerName: '#', field: 'id', sortable: false, filter: false, cellRendererFramework: (params) =>
                <Button style={{ minWidth: "4rem" }} size="sm" as={Link} to={`/${rootPath}/orders/edit/${params.value}?mode=edit`}><BsBoxArrowInUpRight /></Button>
        },
            ...
            <div className="PCTAppContent">
                <div className="PCTAppLeftContent__refundList">
                    <div className="PCTAppLeftContent__header">
                        <Row>
                            <Col><h3 style={{ marginLeft: 10 }}>Cash Sales</h3></Col>
                        </Row>
                        <Row>
                            <div className="buttonGroup" style={{ height: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <div className="buttonGroup__add">
                                    <Button variant='primary' size='sm' as={Link} to={`/${rootPath}`}>New Order</Button>
                                </div>
